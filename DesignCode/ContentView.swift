...
//                        .repeatCount(3, autoreverses: false)
            ...
            BackCardView()
                .frame(width: showCard ? 345 : 340, height: 220, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
            ...
            BackCardView()
                .frame(width: showCard ? 365 : 340, height: 220, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: 20.0) {
                RingView(color1: #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1), color2: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), width: 88, height: 88, percent: 78, show: $show).animation(Animation.easeInOut.delay(0.3))
                VStack(alignment: .leading, spacing: 8.0) {
                    Text("SwiftUI").fontWeight(/*@START_MENU_TOKEN@*/.bold/*@END_MENU_TOKEN@*/)
                    Text("12 of 12 sections done\n10 hours spent so far")
                        .font(.footnote)
